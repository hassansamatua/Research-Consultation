...
import { 
  UltraSimpleExcelList,
  CardExcelList,
  ExcelLikeStudentList
} from '@/components/ui/ExcelLikeStudentList';
import { 
  Users, 
  Plus, 
  RefreshCw,
...
export default function SimpleListPage() {
  ...
  const [viewMode, setViewMode] = useState<'ultra-simple' | 'card' | 'excel-like'>('ultra-simple');
      ...
      <ResponsiveContainer>
        <div className="space-y-4">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
              <h1 className="text-2xl font-bold text-gray-900">Simple Student List</h1>
            ...
            <div className="flex items-center space-x-2">
              ...
              <div className="flex items-center space-x-1 border border-gray-300 rounded p-1">
                <button
                  onClick={() => setViewMode('ultra-simple')}
                  className={cn(
                    'p-1.5 rounded text-xs font-medium transition-colors',
                    viewMode === 'ultra-simple' 
                ...
                <button
                  onClick={() => setViewMode('excel-like')}
                  className={cn(
                    'p-1.5 rounded text-xs font-medium transition-colors',
                    viewMode === 'excel-like' 
                      ? 'bg-blue-600 text-white' 
