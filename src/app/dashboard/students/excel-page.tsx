...
import { 
  ExcelStudentList,
  CompactExcelStudentList
} from '@/components/ui/ExcelStudentList';
import { 
  Users, 
  Plus, 
  RefreshCw,
...
export default function ExcelStudentPage() {
      ...
      <ResponsiveContainer>
        <div className="space-y-4">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
              <h1 className="text-2xl font-bold text-gray-900">Excel Student List</h1>
            ...
            <div className="flex items-center space-x-2">
              <ResponsiveButton
                variant="outline"
                size="sm"
                onClick={() => setViewMode(viewMode === 'compact' ? 'standard' : 'compact')}
              >
                {viewMode === 'compact' ? 'Standard View' : 'Compact View'}
              </ResponsiveButton>
